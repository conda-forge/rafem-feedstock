About rafem-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rafem-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/katmratliff/rafem

Documentation: https://github.com/katmratliff/rafem
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6709&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rafem-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rafem` can be installed with `conda`:
...
It is possible to list all of the versions of `rafem` available on your platform with `conda`:
...
```
mamba search rafem --channel conda-forge
```
...
mamba repoquery search rafem --channel conda-forge

# List packages depending on `rafem`:
mamba repoquery whoneeds rafem --channel conda-forge

# List dependencies of `rafem`:
mamba repoquery depends rafem --channel conda-forge
```
